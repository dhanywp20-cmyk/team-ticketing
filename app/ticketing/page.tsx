...
export default function TicketingSystem() {
  ...
  // ... rest of the functions (createTicket, approveTicket, rejectTicket, reopenTicket, addActivity, createUser, etc.)
  // (keep all existing functions unchanged from original file)
  ...
  return (
    <div className="min-h-screen flex flex-col relative" style={{ backgroundImage: "url(/IVP_Background.png)", backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed" }}>
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        {/* (keep all existing modals unchanged from original file) */}
